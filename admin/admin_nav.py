...
class AdminNavigationFrame(ctk.CTkFrame):
    def __init__(self, master=None, signout_command=None):
        ...
        self.user_image = load_image(os.path.join(icon_path, "user_icon.png"))
        self.inventory_image = load_image(os.path.join(icon_path, "inventory_icon.png"))
        self.reports_image = load_image(os.path.join(icon_path, "report_icon.png"))
